...
function ProsesNaiveBayes($db_object, $id_data_uji=0, $jenis_kelamin, $usia, $sekolah, 
	...
	echo "<table class='table table-bordered table-striped  table-hover' style='width:40%'>";
		echo "<tr>";
			echo "<td><b><u>Perguruan Tinggi:</u></b></td>";
			echo "<td>Sanguin</td>";
			echo "<td>Koleris</td>";
                        echo "<td>Melankolis</td>";
                        echo "<td>Plegmatis</td>";
...
//        echo "P(usia|Plegmatis)=".number_format($prob_usia_plegmatis, dec())."<br>";
	...
	if($show_perhitungan){
        echo "<br>";
	echo "P(Perguruan Tinggi|Sanguin)=".number_format($prob_sekolah_sanguin, dec())."<br>";
	echo "P(Perguruan Tinggi|Koleris)=".number_format($prob_sekolah_koleris, dec())."<br>";
        echo "P(Perguruan Tinggi|Melankolis)=".number_format($prob_sekolah_melankolis, dec())."<br>";
        echo "P(Perguruan Tinggi|Plegmatis)=".number_format($prob_sekolah_plegmatis, dec())."<br>";
        }
